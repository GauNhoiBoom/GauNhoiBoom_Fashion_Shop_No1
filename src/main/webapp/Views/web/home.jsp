...
<body>
	...
	<section class="hero-section">
		<div class="hero-items owl-carousel">
			...
			<div class="single-hero-items set-bg"
				data-setbg="<c:url value='template/web/img/hero-2.jpg'/>">
				<div class="container">
					<div class="row">
						<div class="col-lg-5">
							<span>Bag,kids</span>
				...
				<div class="col-lg-4">
					<div class="single-banner">
						...
						<div class="inner-text">
							<a href="<c:url value='/ListProducts?bstID=2'/>"><h4>Men’s</h4></a>
						</div>
					</div>
				</div>
				<div class="col-lg-4">
					<div class="single-banner">
						...
						<div class="inner-text">
							<a href="<c:url value='/ListProducts?bstID=1'/>"><h4>Women’s</h4></a>
						</div>
					</div>
				</div>
				<div class="col-lg-4">
					<div class="single-banner">
						...
						<div class="inner-text">
							<a href="<c:url value='/ListProducts?bstID=3'/>"><h4>Kid’s</h4></a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-lg-3">
					<div class="product-large set-bg"
						...
						<h2>Women’s</h2>
						<a href="<c:url value='/ListProducts?bstID=1'/>">Discover More</a>
					</div>
				</div>
				<div class="col-lg-8 offset-lg-1">
					...
					<div class="product-slider owl-carousel">
						<c:forEach items="${listWoman }" var="a" >
						<div class="product-item">
							<div class="pi-pic">
								<img src="<c:url value='template/web/img/products/women-1.jpg'/>"
									alt="">
							...
							<div class="pi-text">
								<a href="#">
									<h5>${a.getTensanpham() }</h5>
								</a>
								<div class="product-price">
									${a.getGia()/2 }$ <span>${a.getGia() }$</span>
								</div>
							</div>
						</div>
					</c:forEach>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg-8">
					...
					<div class="product-slider owl-carousel">
					<c:forEach items="${listMan }" var="a" >
						<div class="product-item">
							<div class="pi-pic">
								<img src="<c:url value='template/web/img/products/man-3.jpg'/>"
									alt="">
								<div class="sale">Sale</div>
								<div class="icon">
									<i class="icon_heart_alt"></i>
				...
				<div class="col-lg-3 offset-lg-1">
					<div class="product-large set-bg m-large"
						...
						<h2>Men’s</h2>
						<a href="<c:url value='/ListProducts?bstID=2'/>">Discover More</a>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-lg-4 col-md-6">
					<div class="single-latest-blog">
						<img src="<c:url value='template/web/img/latest-1.jpg'/>" alt="">
				...
				<div class="col-lg-4 col-md-6">
					<div class="single-latest-blog">
						<img src="<c:url value='template/web/img/latest-2.jpg'/>" alt="">
						<div class="latest-text">
							<div class="tag-list">
								<div class="tag-item">
									<i class="fa fa-calendar-o"></i> May 4,2019
				...
				<div class="col-lg-4 col-md-6">
					<div class="single-latest-blog">
						<img src="<c:url value='template/web/img/latest-3.jpg'/>" alt="">
						<div class="latest-text">
							<div class="tag-list">
								<div class="tag-item">
									<i class="fa fa-calendar-o"></i> May 4,2019
				...
				<div class="row">
					<div class="col-lg-4">
						<div class="single-benefit">
							<div class="sb-icon">
								<img src="<c:url value='template/web/img/icon-1.png'/>" alt="">
							</div>
							<div class="sb-text">
								<h6>Free Shipping</h6>
					...
					<div class="col-lg-4">
						<div class="single-benefit">
							<div class="sb-icon">
								<img src="<c:url value='template/web/img/icon-2.png'/>" alt="">
							</div>
							<div class="sb-text">
